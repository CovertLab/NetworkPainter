...
function start($email = '', $error = '') {
    ...
    echo "    <p>$error</p>";    
	echo "    <table width=\"100%\" style=\"padding:0px;\">";	
    ...
    echo "      <tr>";
    echo "        <td>Email</td>";
	echo "        <td style=\"padding-left:10px;\"><input type=\"text\" name=\"email\" style=\"width:100%;\" value=\"$email\"/></td>";
    echo "      </tr>";
    echo "      <tr>";
    echo "        <td>Password</td>";
	echo "        <td style=\"padding-left:10px;\"><input type=\"password\" name=\"password\" style=\"width:100%;\" /></td>";
    echo "      </tr>";
    echo "      <tr>";
    ...
    echo "      <tr>";
    echo "        <td colspan=\"2\"><b>2. Use as guest</b></td>";
    echo "      </tr>";
	echo "      <tr>";
	echo "        <td><i>No registration required</i></td>";
	echo "        <td style=\"text-align:right;\"><button type=\"submit\" style=\"position:relative; top:-16px;\"><div><span>Login</span></div></button></td>";
	echo "      </tr>";
	echo "    </form>\n";
	echo "    </table>";
	echo "</div>\n";
